...
class BugNJAGCOptionsTab(BugOptionsTab.BugOptionsTab):
	...
	def create(self, screen):
		...
		self.addColorDropdown(screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_ISOLATION", True)
		self.addColorDropdown(screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_EXPANSION", True)
		self.addColorDropdown(screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_GALACTIC", True)
		self.addColorDropdown(screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_FAR_FUTURE", True)
