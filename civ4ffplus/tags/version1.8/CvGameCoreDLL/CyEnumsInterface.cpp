...
//Added in Final Frontier Plus: TC01
		.value("GAMEOPTION_DELAYED_WORMHOLES", GAMEOPTION_DELAYED_WORMHOLES)
		.value("GAMEOPTION_NO_ALIENS", GAMEOPTION_NO_ALIENS)
		.value("GAMEOPTION_NO_STARBASE_MISSILES", GAMEOPTION_NO_STARBASE_MISSILES)
		.value("GAMEOPTION_PIRATE_HORDES", GAMEOPTION_PIRATE_HORDES)
		.value("GAMEOPTION_NO_PIRATE_EXP_CAP", GAMEOPTION_NO_PIRATE_EXP_CAP)
		.value("GAMEOPTION_TROOP_TRANSPORTS", GAMEOPTION_TROOP_TRANSPORTS)
		.value("GAMEOPTION_MULTIPLE_PRODUCTION", GAMEOPTION_MULTIPLE_PRODUCTION)			//Multiple Production: Added by Denev 07/10/2009
		.value("GAMEOPTION_PRODUCTIVE_PIRATE_CITIES", GAMEOPTION_PRODUCTIVE_PIRATE_CITIES)
		.value("GAMEOPTION_REDUCED_PIRATES", GAMEOPTION_REDUCED_PIRATES)
//End of Final Frontier Plus
	...
	python::enum_<ActivityTypes>("ActivityTypes")
		...
		.value("ACTIVITY_SENTRY_WHILE_HEAL", ACTIVITY_SENTRY_WHILE_HEAL)		//Added in Final Frontier Plus: TC01 (source: Pep's Unit Orders)
	...
	python::enum_<MissionTypes>("MissionTypes")
		...
		.value("MISSION_SENTRY_WHILE_HEAL", MISSION_SENTRY_WHILE_HEAL)		//Added in Final Frontier Plus: TC01
